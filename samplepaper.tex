...
% References moved here at end

\bibliographystyle{spphys} 
\bibliography{} 

% Add references manually here if not using BibTeX

% Example references:
% 1) Spotify Million Playlist Dataset Challenge - AIcrowd - https://www.aicrowd.com/challenges/spotify-million-playlist-dataset-challenge 
% 2) Schedl et al., Current challenges... - International Journal... 
% 3) Jacobson et al., Music personalization at Spotify... 
% 4) Lee et al., How similar is too similar?... 
% 5) Bertin-Mahieux et al., The Million Song Dataset...

% You can uncomment above lines if you're using BibTeX or add your references manually below

% Example manual entries:
%\begin{thebibliography}{99} 
%\bibitem{} Author1 et al., Title..., Journal..., Year... 
%\bibitem{} Author2 et al., Title..., Journal..., Year...
%\end {thebibliography} 

% Appendix section remains unchanged
